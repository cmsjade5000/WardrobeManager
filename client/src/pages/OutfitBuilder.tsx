...
import { Plus, X, ArrowUp, ArrowDown, Save, Loader2, Layers, Shirt } from "lucide-react";
...
export default function OutfitBuilder() {
  ...
  const handleSave = () => {
    if (!outfitName) return toast({ title: "Name required", description: "Please name your outfit first.", variant: "destructive" });
    if (selectedItems.length === 0) return toast({ title: "Add items first", description: "Select at least one item from your wardrobe.", variant: "destructive" });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-serif font-bold text-foreground" data-testid="page-title">Outfit Builder</h2>
        <p className="text-muted-foreground mt-1">Create and save your favorite looks.</p>
      </div>
          ...
          <div className="flex-1 p-8 overflow-y-auto flex flex-col items-center justify-center min-h-0 relative">
            {selectedItems.length === 0 ? (
              <div className="text-center text-muted-foreground">
                ...
                <p className="font-serif font-medium text-lg mb-1">Start building your look</p>
              ...
              <div className="flex flex-col items-center gap-4 w-full max-w-md pb-20" data-testid="outfit-items">
                <AnimatePresence>
        ...
        <div className="lg:w-80 bg-background border rounded-xl flex flex-col overflow-hidden shadow-sm">
          ...
          {itemsLoading ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">No items in your wardrobe yet</p>
              <Link href="/item/new">
